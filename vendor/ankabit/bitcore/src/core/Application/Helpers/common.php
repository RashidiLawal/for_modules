 ...
 */
function upload(string $dictory, UploadedFileInterface $file, string $disk = null): string
{
 ...
 *
 * @param string $file The name of the configuration file to load (e.g., 'settings.php').
 * @return array The merged configuration array from default and optional custom files.
 */
function read_config_array($file)
{
    $config = require BITCORE_CONFIG_PATH . $file;
